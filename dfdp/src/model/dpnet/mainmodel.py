...
from dfdp.src.module.asm.basics import BasicBlock, depthwise_separable_conv
from dfdp.src.model.model_selector import optimizer_selector, scheduler_selector
from dfdp.src.model.dpnet.modules import Encoder, Encoder2, Decoder, Decoder2
...
class DPNET(pl.LightningModule):
    def __init__(self, option):
        ...
        self.option = option
        self.mindisp = option.mindisp
        self.maxdisp = option.maxdisp
        
        # mode : use bilinar upsampling instead of deconvolution
        mode = None
        
        # Encoder
        self.enc_layer1_1 = Encoder2(option.input_channel * 2, 8, 2)
        self.enc_layer1_2 = Encoder(8 + option.input_channel * 2, 11, 11, 1, 1)
    ...
    def forward(self, xl, yr):
        ...
        pred_final = rearrange([out1], 'n b h w -> b n h w')
