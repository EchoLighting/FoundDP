...
dinov2_vits14 = torch.hub.load('facebookresearch/dinov2', 'dinov2_vits14', weights_only=True)
dinov2_vitb14 = torch.hub.load('facebookresearch/dinov2', 'dinov2_vitb14', weights_only=True)
dinov2_vitl14 = torch.hub.load('facebookresearch/dinov2', 'dinov2_vitl14', weights_only=True)
dinov2_vitg14 = torch.hub.load('facebookresearch/dinov2', 'dinov2_vitg14', weights_only=True)
```
